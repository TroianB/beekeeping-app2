...
body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div>div.grid>span[draggable="true"]{min-width:0!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;font-size:1.35rem!important;line-height:1.05!important;font-weight:400!important}
...
@media(max-width:760px){body.bk-apiary-metric-dropdown #bkApiaryMetricDropdown{padding:.68rem .35rem;font-size:1.05rem}body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div.grid,body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div>div.grid{grid-template-columns:2rem minmax(0,1fr) 5.65rem!important;gap:.32rem!important}body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div.grid>span:nth-child(2){font-size:1.18rem!important}body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div>div.grid>span[draggable="true"]{font-size:1.18rem!important;font-weight:400!important}body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div>div.grid>span:not([draggable="true"]){font-size:1.75rem!important}body.bk-apiary-metric-dropdown .bk-last-update-value{font-size:.9rem!important}}
@media(max-width:390px){body.bk-apiary-metric-dropdown #bkApiaryMetricDropdown{font-size:.92rem;padding:.58rem .25rem}body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div.grid,body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div>div.grid{grid-template-columns:1.8rem minmax(0,1fr) 5rem!important;gap:.24rem!important}body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div>div.grid>span[draggable="true"]{font-size:1.18rem!important;font-weight:400!important}body.bk-apiary-metric-dropdown #root input[placeholder="Search apiaries..."]+div>div>div.grid>span:not([draggable="true"]){font-size:1.52rem!important}body.bk-apiary-metric-dropdown .bk-last-update-value{font-size:.78rem!important}}
`;
